...
function AvailabilityBadge({ isAvailable, stock }) {
          ...
          <table className="w-full text-left min-w-[900px]">
            <thead className="bg-slate-50 text-slate-600 border-b border-slate-200">
              <tr>
                ...
                <th className="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide">Brand</th>
                <th className="px-5 py-3.5 text-xs font-semibold uppercase tracking-wide">Type</th>
